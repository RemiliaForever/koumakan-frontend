    ...
    export default {
        ...
        methods: {
            async getData() {
                ...
                let data = '' +
                    'Rust是一门专注于安全、速度和并发的编程语言。它设计为高性能、底层控制，同时提供高级语言的强大抽象能力。这些特点使得Rust适合有类C语言经验，正寻求一门更安全的语言的开发者，同时也适合有类Python语言经验，需求更好性能的开发者。   ' +
'\n\nRust多数情况下在编译期进行安全检查和内存管理决策，因此运行时性能几乎没有损失。这使得Rust在一些其他编程语言不擅长的领域大显身手：空间和时间有限，嵌入其他语言，编写底层代码（驱动和操作系统）。Rust也擅长web应用，它驱动着Rust包管理网站。   ' +
'\n## 开发环境配置' +
